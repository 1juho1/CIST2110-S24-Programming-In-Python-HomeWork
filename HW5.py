...
favorite_foods = ['Pizza', 'Sushi', 'Pasta', 'Burger', 'Ice Cream']
...
print("Printing each element in reverse order using for loop:")
...
print("Printing each element and its index using enumerate:")
for index, food in enumerate(favorite_foods):
    print("Index:", index, "Element:", food)
...
print("Reversed List:", reverse_list(favorite_foods))